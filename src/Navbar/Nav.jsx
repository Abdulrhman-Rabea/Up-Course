...
//                     <div className="ml-2">
//                       <Link to="/">
//                         <MyButton bgColor="#ff9500" textColor="text-white" onClick={logout}>
//                           {t("nav.auth.logout")}
//                         </MyButton>
//                       </Link>
//                     </div>
...
//                 >
//                   {i18n.language === "en" ? t("nav.language.switchToArabic") : t("nav.language.switchToEnglish")}
//                 </button>
    ...
    <>
      ...
      <nav className="sticky top-0 z-40 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b border-gray-200/60 shadow-[0_1px_0_rgba(0,0,0,0.02)]">
        <div className="mx-auto max-w-7xl px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="relative flex h-16 items-center justify-between">
            {/* Hamburger: يظهر فقط على الموبايل */}
              ...
              <div className="hidden md:flex items-center ml-2">
                {!user ? (
                  <div className="flex items-center gap-2 lg:gap-4">
                    ...
                    <Link to="login">
                      <MyButton bgColor="#ff9500" textColor="text-white" className="btn-primary w-full shadow-sm hover:shadow active:scale-[0.99] text-[13px] lg:text-sm px-3 lg:px-4 py-1.5 lg:py-2" >
                        {t("nav.auth.login")}
                      </MyButton>
                    </Link>
                  </div>
                  ...
                  <>
                    <span id="userNameNav" className="mr-3 text-[13px] lg:text-sm text-gray-800 max-w-[160px] truncate">
                      {t("nav.auth.welcome", { name: userName })}
                    </span>
                    <div className="ml-2">
                      <Link to="/">
                        <MyButton bgColor="#ff9500" textColor="text-white" className="text-[13px] lg:text-sm px-3 lg:px-4 py-1.5 lg:py-2" onClick={logout}>
                          {t("nav.auth.logout")}
                        </MyButton>
                      </Link>
                    </div>
        ...
        {/* Mobile menu: يظهر فقط < md */}
        <div className={`${isMenuOpen ? "block" : "hidden"} md:hidden`} id="mobile-menu">
          <div className="px-3 pt-3 pb-6">
            <div className="rounded-2xl bg-white shadow-md ring-1 ring-gray-200/70 overflow-hidden">
              <div className="space-y-1 p-2">
                <Link to="/" className="block rounded-lg px-3 py-2 text-base font-medium text-gray-800 hover:bg-gray-100 hover:text-gray-900 transition">
                  {t("nav.menu.home")}
                </Link>
                <Link to="/Courses" className="block rounded-lg px-3 py-2 text-base font-medium text-gray-800 hover:bg-gray-100 hover:text-gray-900 transition">
                  {t("nav.menu.courses")}
                </Link>
                {user && (
                  <Link to="/my-courses" className="block rounded-lg px-3 py-2 text-base font-medium text-gray-800 hover:bg-gray-100 hover:text-gray-900 transition">
                    {t("nav.menu.myCourses")}
                  </Link>
                )}
                <Link to="/about" className="block rounded-lg px-3 py-2 text-base font-medium text-gray-800 hover:bg-gray-100 hover:text-gray-900 transition">
                  {t("nav.menu.about")}
                </Link>
                <Link to="/contact" className="block rounded-lg px-3 py-2 text-base font-medium text-gray-800 hover:bg-gray-100 hover:text-gray-900 transition">
                  {t("nav.menu.contact")}
                </Link>
                <Link to="/wishlist" className="block rounded-lg px-3 py-2 text-base font-medium text-gray-800 hover:bg-gray-100 hover:text-gray-900 transition">
                  {t("nav.menu.wishlist")}
                </Link>
              </div>
