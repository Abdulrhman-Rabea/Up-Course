...
// script.src = `https://www.sandbox.paypal.com/sdk/js?client-id=${clientId}&currency=${currency}&components=buttons&intent=capture&enable-funding=card`;
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-semibold text-gray-900 mb-2">{t("checkout.empty.title")}</h2>
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl mx-auto mb-8">
        <div className="text-center">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">{t("checkout.header.title")}</h1>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 lg:p-8 h-fit">
            <h2 className="text-xl font-semibold text-gray-900 mb-6">{t("checkout.summary.title")}</h2>
            ...
            <div className="space-y-6">
              ...
              {/* Course Details */}
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">{state.course.title}</h3>
                {state.course.description && (
                  <p className="text-gray-600 text-sm leading-relaxed">{state.course.description}</p>
                )}
              </div>

              {/* Course Features */}
              <div className="border-t border-gray-100 pt-6">
                <h4 className="text-sm font-medium text-gray-900 mb-4">{t("checkout.summary.whatsIncluded")}</h4>
              ...
              <div className="border-t border-gray-100 pt-6">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-gray-600">{t("checkout.pricing.coursePrice")}</span>
                  <span className="text-gray-900 font-medium">${state.course.price}</span>
                </div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-gray-600">{t("checkout.pricing.platformFee")}</span>
                  <span className="text-gray-900 font-medium">$0.00</span>
                </div>
                <div className="border-t border-gray-100 pt-2 mt-4">
                  <div className="flex justify-between items-center">
                    <span className="text-lg font-semibold text-gray-900">{t("checkout.pricing.total")}</span>
                    <span className="text-2xl font-bold text-orange-600">${state.course.price}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 lg:p-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-6">{t("checkout.payment.title")}</h2>
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-6">
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm font-medium text-green-800">{t("checkout.payment.secure.title")}</p>
                  <p className="text-xs text-green-600">{t("checkout.payment.secure.subtitle")}</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="text-center">
                <p className="text-xs text-gray-500 mt-4">
                  ...
                  <a href="#" className="text-orange-600 hover:text-orange-700 underline">{t("checkout.payment.termsNote.tos")}</a>
                  {' '}{t("checkout.payment.termsNote.and")}{' '}
                  <a href="#" className="text-orange-600 hover:text-orange-700 underline">{t("checkout.payment.termsNote.privacy")}</a>
                </p>
              </div>
            </div>
