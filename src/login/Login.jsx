      ...
      <div className="flex flex-col lg:flex-row justify-center items-center w-full max-w-7xl gap-20">
		...
		<div className="min-h-screen flex items-center justify-center p-4 bg-oklch(96.7% 0.001 286.375)">
			<div className="flex flex-col lg:flex-row justify-center items-center w-full max-w-7xl gap-20">
				...
				<div className="w-full lg:w-[600px] flex items-center justify-center p-8">
					<div className="oklch(98.5% 0 0) shadow-lg p-8 rounded-2xl w-full max-w-sm">
						<h1 className="text-center mb-6 text-black font-bold text-2xl">
							Login
						</h1>
						<div className="text-center mb-4">
							<p className="text-center text-md text-gray-500 ">
						...
						<form onSubmit={handleSubmit}>
							<div className="mb-4">
								<label className="block text-black-400 text-sm font-bold mb-2 text-left">
									Email
								</label>
								<input
									type="text"
							...
							<button className="flex items-center justify-center space-x-2 w-full py-2 px-4 rounded border text-gray-700 hover:bg-gray-100 transition-colors mb-4 focus:outline-none focus:ring-0">
