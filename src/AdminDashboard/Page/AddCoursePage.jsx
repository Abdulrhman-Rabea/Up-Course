...
function AddCoursePage() {
	...
	const handleSubmit = async (e) => {
		...
		if (!title || !playlistId || !description || !price || !imageFile) {
			setMessage(t("You should fill all required Data"));
			return;
		}
		...
		<div className="min-h-screen bg-gray-50 flex justify-center items-center">
			<div className="relative bg-white p-8 rounded-lg shadow-md w-full max-w-2xl">
				<div className="mb-6 grid grid-cols-3 items-center">
					...
					<Link
						to="/AdminPage"
						className="text-xs text-gray-500 justify-self-end"
					>
				...
				<form onSubmit={handleSubmit}>
					...
					<div className="mb-4">
						...
						>
							...
							<option value="Programming">
								{t("addCourse.category.programming")}
							</option>
							<option value="Graphic Design">
								{t("addCourse.category.graphicDesign")}
							</option>
							<option value="Social Media">
								{t("addCourse.category.socialMedia")}
							</option>
							<option value="Marketing">
								{t("addCourse.category.marketing")}
							</option>
					...
					>
						{isLoading
							? t("addCourse.buttons.saving")
							: t("addCourse.buttons.submit")}
					</button>
					...
					{message && (
						<p
							className={`mt-4 text-center text-sm ${
								message.includes(t("addCourse.messages.errorWord"))
									? "text-red-500"
									: "text-green-500"
							}`}
						>
